<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <List&lt;Allegies&gt; offline label="Allegies" v-model="value.allegies" :editMode="editMode" @change="change"/>
            <AllegiesManager offline label="Allegies" v-model="value.allegies" :editMode="editMode" @change="change"/>
        </v-card-text>
